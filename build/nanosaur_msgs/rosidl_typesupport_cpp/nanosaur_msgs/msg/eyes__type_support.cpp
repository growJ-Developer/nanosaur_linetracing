...
static const _Eyes_type_support_symbol_names_t _Eyes_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nanosaur_msgs, msg, Eyes)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nanosaur_msgs, msg, Eyes)),
  }
};
...
{
  return &::nanosaur_msgs::msg::rosidl_typesupport_cpp::Eyes_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nanosaur_msgs, msg, Eyes)() {
  return get_message_type_support_handle<nanosaur_msgs::msg::Eyes>();
}
