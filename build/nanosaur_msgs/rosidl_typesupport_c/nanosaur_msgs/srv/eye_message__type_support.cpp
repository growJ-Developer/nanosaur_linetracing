...
static const _EyeMessage_Request_type_support_symbol_names_t _EyeMessage_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nanosaur_msgs, srv, EyeMessage_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nanosaur_msgs, srv, EyeMessage_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nanosaur_msgs, srv, EyeMessage_Request)() {
  return &::nanosaur_msgs::srv::rosidl_typesupport_c::EyeMessage_Request_message_type_support_handle;
}
...
static const _EyeMessage_Response_type_support_symbol_names_t _EyeMessage_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nanosaur_msgs, srv, EyeMessage_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nanosaur_msgs, srv, EyeMessage_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nanosaur_msgs, srv, EyeMessage_Response)() {
  return &::nanosaur_msgs::srv::rosidl_typesupport_c::EyeMessage_Response_message_type_support_handle;
}
...
static const _EyeMessage_type_support_symbol_names_t _EyeMessage_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nanosaur_msgs, srv, EyeMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nanosaur_msgs, srv, EyeMessage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, nanosaur_msgs, srv, EyeMessage)() {
  return &::nanosaur_msgs::srv::rosidl_typesupport_c::EyeMessage_service_type_support_handle;
}
