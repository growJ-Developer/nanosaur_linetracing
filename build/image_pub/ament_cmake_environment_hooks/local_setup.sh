...
: ${AMENT_CURRENT_PREFIX:="/ws/install/image_pub"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/image_pub/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/image_pub/environment/path.sh"
