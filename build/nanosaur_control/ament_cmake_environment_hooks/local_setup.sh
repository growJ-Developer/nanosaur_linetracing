...
: ${AMENT_CURRENT_PREFIX:="/ws/install/nanosaur_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nanosaur_control/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nanosaur_control/environment/path.sh"
